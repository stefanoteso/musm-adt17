...
\begin{itemize}
    ...
    \item \stefano{@Bereket: please add here the  relevant literature that
     ...
     \item \Bereket{Craig Boutilier, Preference Elicitation and Preference Learning in Social Choice; International Conference on AI and OR Techniques in Constriant Programming for Combinatorial Optimization Problems pp 1-1  (2011)}
\end{itemize}
